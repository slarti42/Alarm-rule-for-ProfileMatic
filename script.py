...
def check_for_alarm_rule(timestamp):
	if pm_intf.getRuleIdForName('Alarm rule'):
		...
		alarm_rule_struct = dbus.Struct((dbus.String(u'{someruleid}'), dbus.String(u'Alarm rule'), dbus.Boolean(True), dbus.Boolean(False), dbus.Struct((dbus.Struct((dbus.Int32(0), dbus.Int32(0), dbus.Int32(0), dbus.Int32(0)), signature=None), dbus.Struct((dbus.Int32(0), dbus.Int32(0), dbus.Int32(0), dbus.Int32(0)), signature=None), dbus.Array([dbus.Int32(6)], signature=dbus.Signature('i')), dbus.Array([], signature=dbus.Signature('i')), dbus.Int32(0), dbus.Array([], signature=dbus.Signature('s')), dbus.Int32(0), dbus.Int32(-1), dbus.Struct((dbus.Array([], signature=dbus.Signature('ay')), dbus.Boolean(False)), signature=None), dbus.Int32(0), dbus.Int32(-1), dbus.Struct((dbus.Int32(-1), dbus.Int32(-1)), signature=None), dbus.Struct((dbus.String(u''), dbus.String(u''), dbus.Int32(0), dbus.Int32(0)), signature=None)), signature=None), dbus.Struct((dbus.String(u''), dbus.Boolean(False), dbus.Int32(-1), dbus.Int32(-1), dbus.Boolean(False), dbus.Int32(-1), dbus.Boolean(False), dbus.Int32(-1), dbus.Boolean(False), dbus.Int32(-1), dbus.Boolean(False), dbus.Int32(-1), dbus.Boolean(False), dbus.Int32(-1), dbus.Boolean(False), dbus.String(u'For version 2.1'), dbus.String(u''), dbus.Array([], signature=dbus.Signature('(usis)')), dbus.String(u''), dbus.Boolean(False), dbus.Int32(0), dbus.Struct((dbus.Array([], signature=dbus.Signature('s')),), signature=None), dbus.Int32(-1), dbus.Struct((dbus.String(u''), dbus.Int32(-1), dbus.Int32(-1), dbus.String(u'')), signature=None)), signature=None)), signature=None)
